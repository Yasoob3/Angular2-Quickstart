...
const Zone = (function (global) {
    class Zone {
        ...
        static get current() { return _currentZone; }
        ;
        ...
        if (!_isDrainingMicrotaskQueue) {
            ...
            while (_uncaughtPromiseErrors.length) {
                ...
                for (let i = 0; i < uncaughtPromiseErrors.length; i++) {
                    const uncaughtPromiseError = uncaughtPromiseErrors[i];
                    try {
    ...
    class ZoneAwarePromise {
        ...
        then(onFulfilled, onRejected) {
            const chainPromise = new ZoneAwarePromise(null);
